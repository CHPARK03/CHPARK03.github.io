...
Solo maker building small things end-to-end — games, personal AI agents, and the tooling that keeps a one-person operation running.

I write here to share what I build and what breaks along the way. Posts are written in Korean first, with an English version included.
