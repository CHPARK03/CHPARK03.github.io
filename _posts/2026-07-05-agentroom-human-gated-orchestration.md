...
그리고 그 과정에서 더 뼈아픈 걸 배웠다. 에이전트의 **"완료했습니다. 빌드 통과합니다."** 는 검증 없이 믿으면 안 된다는 것. 실제로 안 돌려보고 됐다고 하고, 실패를 성공처럼 보고하는 일을 몇 번 겪은 뒤, 내 작업 규칙 문서에는 **"거짓 완료 보고 금지"** 라는 조항이 생겼다. 사람이 규칙 문서에 이런 문장까지 적게 됐다는 것만 봐도 문제가 얼마나 큰지 짐작이 간다.
